...
export default function PlaygroundPage() {
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <div className="jun-layout jun-layout-standalone bg-sidebar">
        {/* Header */}
        <header className="jun-header border-none bg-transparent">
          <div className="container flex items-center gap-4">
            <button className="jun-edgeDrawerTrigger">
        ...
        <aside
          ...
          md:jun-edgeSidebar-collapsed-w-[66px] 
        ...
        {/* Main Content */}
        <main className="jun-content bg-transparent p-4">
          <div className="h-full border rounded shadow-md bg-white p-4">
            <div className="p-6">
            ...
            <div className="jun-insetSidebar jun-insetSidebar-w-[120px] max-h-full">
