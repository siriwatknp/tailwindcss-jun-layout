...
- `jun-edgeSidebar`: the sidebar container
  - `jun-edgeContent`: the sidebar body (background should be set to this element)

```jsx
<aside className="jun-edgeSidebar">
  <div className="jun-edgeContent">navigation...</div>
</aside>
```
...
To customize the width of the sidebar in **collapsed** state, use `jun-edgeSidebar-collapsed-w-[*]`:
...
To make the collapsed sidebar expand when hover, use `jun-edgeSidebar-hoverExpand`:

```jsx
<div className="jun-edgeSidebar jun-edgeSidebar-permanent-hoverExpand">
  <div className="jun-edgeContent">...</div>
</div>
```
...
<ComponentPreview preview name="edgeSidebar-hoverExpand" />
...
| `jun-edgeContent`                                      | The content container of the sidebar (Required)             |
...
| `jun-edgeSidebar-permanent-hoverExpand`                | Makes the collapsed sidebar expand on hover                 |
...
| `jun-edgeCollapsed-visible`                            | Shows element only when sidebar is collapsed                |
| `jun-edgeUncollapsed-visible`                          | Shows element only when sidebar is expanded                 |
